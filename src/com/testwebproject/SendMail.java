...
public class SendMail {
	...
	public static void send(String toSend, String fnameemail) {
		...
		try {
			...
			String link = "<b> <i> <a href=\"http://localhost:8080/WebProject/reset_password.jsp?email="+ toSend + "&fnameemail="+fnameemail+"\" target=\"_blank\"> Reset Password </a> </i> </b>";   // target = "_blank" opens URL in a new tab 
